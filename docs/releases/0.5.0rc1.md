...
- macOS desktop installer: `OpenSquilla-0.5.0rc1-mac-arm64.dmg`
- macOS desktop zip: `OpenSquilla-0.5.0rc1-mac-arm64.zip`
- Windows desktop installer: `OpenSquilla-0.5.0rc1-win-x64.exe`
